...
public class CreateEmployeeDto {
	...
	public CreateEmployeeDto(String username, String firstName, String lastName, String color, String email,
	...
	public static Employee toEmployee(CreateEmployeeDto model) {
		if (model != null) {
