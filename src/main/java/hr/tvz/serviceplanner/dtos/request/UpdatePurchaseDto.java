...
public class UpdatePurchaseDto {
	...
	public UpdatePurchaseDto(String currency, Long valueInSmallestCurrency, Date purchaseDate, Date paymentDate,
	...
	public static Purchase toPurchase(UpdatePurchaseDto model) {
		if (model != null) {
			return new Purchase(model.currency, model.valueInSmallestCurrency, model.itemsCount, null,
					model.purchaseDate, model.paymentDate, new Product(model.productId), new Customer(model.customerId),
					new Price(model.priceId));
		}
		return null;
	}
