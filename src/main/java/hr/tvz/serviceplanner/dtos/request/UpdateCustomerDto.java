...
public class UpdateCustomerDto {
	...
	public UpdateCustomerDto(String firstName, String lastName, String email, String phone, String comment) {
		super();
	...
	public static Customer toCustomer(UpdateCustomerDto model) {
		if (model != null) {
