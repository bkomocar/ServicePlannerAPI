...
public class CreatePurchaseDto {
	...
	public CreatePurchaseDto(String currency, Long valueInSmallestCurrency, Date purchaseDate, Date paymentDate,
	...
	public static Purchase toPurchase(CreatePurchaseDto model) {
		if (model != null) {
			Purchase purchase = new Purchase(model.currency, model.valueInSmallestCurrency, model.itemsCount, null,
					model.purchaseDate, model.paymentDate, new Product(model.productId), new Price(model.priceId));
