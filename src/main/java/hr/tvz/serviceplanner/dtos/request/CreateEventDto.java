...
public class CreateEventDto {
	...
	public CreateEventDto(Employee employee, Product product, Date startTime, Date endTime, List<Purchase> purchases) {
		super();
	...
	public static Event toEvent(CreateEventDto model) {
		if (model != null) {
