...
public class UpdateEmployeeDto {
	...
	public UpdateEmployeeDto(String username, String firstName, String lastName, String color, String email,
	...
	public static Employee toEmployee(UpdateEmployeeDto model) {
		if (model != null) {
