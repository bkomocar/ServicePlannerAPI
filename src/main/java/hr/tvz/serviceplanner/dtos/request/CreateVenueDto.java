...
public class CreateVenueDto implements Serializable {
	...
	public static Venue toVenue(CreateVenueDto model) {
		if (model != null) {
	...
	public CreateVenueDto(String name, String owner, String description, Time openTime, Time closeTime,
			VenueType type) {
		super();
		this.name = name;
		this.owner = owner;
